...
namespace SpiritboundMod.Modules
{
    internal static class Assets
    {
        ...
        internal static AssetBundle LoadAssetBundle(string bundleName)
        {
            ...
            try
            {
                assetBundle = AssetBundle.LoadFromFile(Path.Combine(Path.GetDirectoryName(SpiritboundPlugin.instance.Info.Location), "AssetBundles", bundleName));
            }
        ...
        internal static GameObject CreateProjectileGhostPrefab(this AssetBundle assetBundle, string ghostName, bool convertToHopoo = true)
        {
            ...
            if(convertToHopoo) Modules.Assets.ConvertAllRenderersToHopooShader(ghostPrefab);
