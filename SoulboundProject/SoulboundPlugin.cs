...
namespace SoulboundMod
{
    ...
    public class SoulboundPlugin : BaseUnityPlugin
    {
        // if you do not change this, you are giving permission to deprecate the mod-
        //  please change the names to your own stuff, thanks
        //   this shouldn't even have to be said
        public const string MODUID = "com.kenko.Soulbound";
        public const string MODNAME = "Soulbound";
        public const string MODVERSION = "1.0.0";

        // a prefix for name tokens to prevent conflicts- please capitalize all name tokens for convention
        public const string DEVELOPER_PREFIX = "KENKO";

        public static SoulboundPlugin instance;
        ...
        void Awake()
        {
            ...
            NetworkingAPI.RegisterMessageType<Soulbound.Components.SyncBloodExplosion>();
