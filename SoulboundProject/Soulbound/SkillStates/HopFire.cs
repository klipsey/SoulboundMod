...
{
    public class HopFire : BaseSoulboundSkillState
    {
        private GameObject muzzleFlashEffect = SoulboundAssets.arrowMuzzleFlashEffect;
        ...
        public override void OnEnter()
        {
            ...
            if (EntityStates.BrotherMonster.BaseSlideState.slideEffectPrefab && base.characterBody)
            {
                ...
                EffectManager.SimpleEffect(EntityStates.BrotherMonster.BaseSlideState.slideEffectPrefab, position, rotation, true);
            }
            ...
            if (NetworkServer.active)
            {
                ...
                if (hurtBoxes.Length > 0)
                {
                    ...
                    for(int i = 0; i < num; i++)
                    {
                        ...
                        genericDamageOrb.damageValue = base.characterBody.damage * SoulboundStaticValues.arrowBaseDamageCoefficient;
