...
internal enum SoulboundCameraParams
{
    DEFAULT,
    AIM_PISTOL,
    AIM_SNIPER,
...
namespace SoulboundMod.Modules
{
    internal static class CameraParams
    {
        ...
        internal static CameraTargetParams.CameraParamsOverrideHandle OverrideCameraParams(CameraTargetParams camParams, SoulboundCameraParams camera, float transitionDuration = 0.5f)
        {
        ...
        internal static CharacterCameraParams CreateCameraParamsWithData(SoulboundCameraParams camera)
        {
        ...
        internal static CharacterCameraParamsData GetNewParams(SoulboundCameraParams camera)
        {
            ...
            switch (camera)
            {
                ...
                default:
                case SoulboundCameraParams.DEFAULT:
                    paramsData = defaultCameraParams;
                    break;
                case SoulboundCameraParams.AIM_PISTOL:
                    paramsData = aimCameraParams;
                    break;
                case SoulboundCameraParams.AIM_SNIPER:
                    paramsData = sniperAimCameraParams;
                    break;
                case SoulboundCameraParams.EMOTE:
